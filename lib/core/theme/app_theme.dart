...
class AppTheme {
  ...
  static ThemeData light = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch(
      ...
      brightness: Brightness.light, // Ensure the brightness is set here
    ).copyWith(
      surface: AppColor.backgroundGray,
    ),
  );
  ...
  static ThemeData dark = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch(
      primarySwatch: AppColor.primarySwatch,
      brightness: Brightness.dark, // Ensure the brightness is set here
    ).copyWith(
